...
export default function SocialLogin({ onSocialLogin, isLoading = false, disabled = false }: SocialLoginProps) {
			...
			{providers.map((provider) => (
				<button
					...
					className={`
						...
						${disabled || isLoading ? "opacity-50 cursor-not-allowed" : "hover:shadow-md transform hover:-translate-y-0.5"}
					`}
				>
