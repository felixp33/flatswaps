...
const getFlatById = (id: string) => {
	...
	return {
		...
		amenities: {
			...
			building: ["Elevator", "Bike Storage", "Courtyard"],
			neighborhood: ["Near Public Transport", "Supermarket Nearby", "Restaurants"],
		},
		availability: {
			available: true,
			flexibleDates: true,
			...
			recent: [
				{
					...
					rating: 5,
					date: "2024-03-15",
					comment: "Amazing location and beautifully maintained apartment. Maria was very responsive and helpful.",
				},
				{
					id: "2",
					author: "Sophie L.",
					rating: 5,
					date: "2024-03-08",
					comment: "Perfect flat for exploring Berlin. Great transport connections and lovely neighborhood.",
				},
			],
		},
	};
